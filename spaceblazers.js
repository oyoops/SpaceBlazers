...
function draw() {
	...
	if (gameState === "start") {
		...
		drawLabel("But Crooked Joe Cronin wants to stop you from achieving your dreams.", width / 2, height / 2 + 170, textSize(), "center");

		textSize(20);
		drawLabel("Destroy as many Joe Cronins as possible by shooting basketballs.", width / 2, height / 2 + 205, textSize(), "center");
		drawLabel("If he makes contact, you\'ll lose your Grind!", width / 2, height / 2 + 225, textSize(), "center");
		drawLabel("Destroy 50 Joe Cronins before running out", width / 2, height / 2 + 245, textSize(), "center"); 
		drawLabel("of Grind to force your way to the Miami Heat!", width / 2, height / 2 + 265, textSize(), "center");
