...
function preload() {
    ...
    spaceshipImg = loadImage('imgs/spaceship.png', img => img.resize(100, 75));
	spaceship2Img = loadImage('imgs/spaceship2.png', img => img.resize(100, 75));
	spaceship3Img = loadImage('imgs/spaceship3.png', img => img.resize(100, 75));
