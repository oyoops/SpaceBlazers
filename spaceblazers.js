...
function draw() {
	...
	if (gameState === "start") {
		...
		textSize(28);
		textStyle(ITALIC);
		drawLabel("You are Damian Lillard, 11-time NBA All Star", width / 2, height / 2 + 10, textSize(), "center");
		drawLabel("and greatest player in Portland franchise history.", width / 2, height / 2 + 35, textSize(), "center");
		textStyle(NORMAL);
		textSize(21);
